...
const RULES = [
  ...
  {
    name: 'spinner-lg-alt-order',
    test: /animate-spin\s+rounded-full\s+h-12\s+w-12\s+border-t-2\s+border-b-2\s+border-indigo-600/g,
    replace: 'spinner-lg',
  },
  {
    name: 'center-layout',
  ...
  {
    name: 'screen-center',
    test: /min-h-screen\s+flex\s+items-center\s+justify-center/g,
    replace: 'screen-center',
  },
  {
  ...
  {
    name: 'container-page',
    test: /container\s+mx-auto\s+p-4/g,
    replace: 'container-page',
  },
  {
    name: 'header-row',
    test: /flex\s+flex-col\s+sm:flex-row\s+justify-between\s+items-start\s+sm:items-center\s+gap-4/g,
    replace: 'header-row',
  },
  {
    name: 'title-page',
    test: /text-2xl\s+sm:text-3xl\s+font-bold\s+text-gray-800\s+dark:text-white/g,
    replace: 'title-page',
  },
  {
    name: 'form-label-md',
    test: /mb-1\s+block\s+text-sm\s+font-semibold\s+text-gray-700\s+dark:text-gray-300/g,
    replace: 'form-label-md',
  },
  {
    name: 'frame',
    test: /rounded-lg\s+overflow-hidden\s+border\s+border-gray-300\s+dark:border-gray-600/g,
    replace: 'frame',
  },
];
